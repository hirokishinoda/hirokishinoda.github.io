...
const AchievementsTimeline = () => {
    const achievements: Array<Achievement> = [
        {
            title      : "2019年8月 学会発表",
            description: `電子情報通信学会 2019年ソサイエティ大会\n「LSTMを用いた降雨量データの欠損補間」`,
